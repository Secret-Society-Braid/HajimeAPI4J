...
public class ListRequestAsync implements Runnable {

    //Declare fields
    private Logger logger = LoggerFactory.getLogger(ListRequestAsync.class);
    private List<Map<String, Object>> result = Collections.emptyList();
    private Map<String, Object> param; 
    private Request req = null;
    private boolean flag = false;
    
    public ListRequestAsync(Map<String, Object> param) {
